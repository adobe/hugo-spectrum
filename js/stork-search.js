 ...
 *
 */
const initPromise = stork.initialize("https://opensource.adobe.com/hugo-spectrum/stork/stork.wasm");
const downloadPromise = stork.downloadIndex("site-search-index", "https://opensource.adobe.com/hugo-spectrum/stork/site-index.st", {forceOverwrite: true});
