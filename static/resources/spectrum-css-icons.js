document.head.insertAdjacentHTML('beforeend', '<svg class="_coral-Icon-collection" aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg">
    <symbol id="spectrum-css-icon-AlertMedium" viewBox="0 0 18 18">
        <path
    ...
    <symbol id="spectrum-css-icon-AlertSmall" viewBox="0 0 14 14">
        <path
    ...
    <symbol id="spectrum-css-icon-ArrowDownSmall" viewBox="0 0 8 10">
        <path
    ...
    <symbol id="spectrum-css-icon-ArrowLeftMedium" viewBox="0 0 14 10">
        <path
            d="M12.99 4H3.414l2.283-2.283A1 1 0 1 0 4.283.303l-3.98 3.99a1 1 0 0 0 0 1.414l3.98 3.99a1 1 0 1 0 1.414-1.414L3.414 6h9.576a1 1 0 1 0 0-2z"/>
    </symbol>
    <symbol id="spectrum-css-icon-ArrowUpSmall" viewBox="0 0 8 10">
        <path
            d="M7.99 3.99a1 1 0 0 1-1.707.707L5 3.414V9a1 1 0 0 1-2 0V3.414L1.717 4.697A1 1 0 1 1 .303 3.283l2.99-2.98a1 1 0 0 1 1.414 0l2.99 2.98a.997.997 0 0 1 .293.707z"/>
    </symbol>
    <symbol id="spectrum-css-icon-Asterisk" viewBox="0 0 8 8">
        <path
    ...
    <symbol id="spectrum-css-icon-CheckmarkMedium" viewBox="0 0 12 12">
        <path
    ...
    <symbol id="spectrum-css-icon-CheckmarkSmall" viewBox="0 0 10 10">
        <path
    ...
    <symbol id="spectrum-css-icon-ChevronDownMedium" viewBox="0 0 10 6">
        <path
    ...
    <symbol id="spectrum-css-icon-ChevronDownSmall" viewBox="0 0 8 6">
        <path
    ...
    <symbol id="spectrum-css-icon-ChevronLeftLarge" viewBox="0 0 12 16">
        <path
    ...
    <symbol id="spectrum-css-icon-ChevronLeftMedium" viewBox="0 0 6 10">
        <path
            d="M5.697 8.283L2.414 5l3.283-3.283A1 1 0 1 0 4.283.303l-3.98 3.99a1 1 0 0 0 0 1.414l3.98 3.99a1 1 0 1 0 1.414-1.414z"/>
    </symbol>
    <symbol id="spectrum-css-icon-ChevronRightLarge" viewBox="0 0 12 16">
        <path
    ...
    <symbol id="spectrum-css-icon-ChevronRightMedium" viewBox="0 0 6 10">
        <path
    ...
    <symbol id="spectrum-css-icon-ChevronRightSmall" viewBox="0 0 6 8">
        <path
    ...
    <symbol id="spectrum-css-icon-ChevronUpSmall" viewBox="0 0 8 6">
        <path
    ...
    <symbol id="spectrum-css-icon-CornerTriangle" viewBox="0 0 5 5">
        <path
            d="M4.74.01a.25.25 0 0 0-.177.073l-4.48 4.48a.25.25 0 0 0 .177.427h4.48a.25.25 0 0 0 .25-.25V.26a.25.25 0 0 0-.25-.25z"/>
    </symbol>
    <symbol id="spectrum-css-icon-CrossLarge" viewBox="0 0 12 12">
        <path
    ...
    <symbol id="spectrum-css-icon-CrossMedium" viewBox="0 0 8 8">
        <path
    ...
    <symbol id="spectrum-css-icon-CrossSmall" viewBox="0 0 8 8">
        <path
    ...
    <symbol id="spectrum-css-icon-InfoSmall" viewBox="0 0 14 14">
        <path
    ...
    <symbol id="spectrum-css-icon-Magnifier" viewBox="0 0 16 16">
        <path
    ...
    <symbol id="spectrum-css-icon-SkipLeft" viewBox="0 0 9 10">
        <path
    ...
    <symbol id="spectrum-css-icon-SkipRight" viewBox="0 0 9 10">
        <path d="M8 .01a1 1 0 0 0-1 1v7.98a1 1 0 1 0 2 0V1.01a1 1 0 0 0-1-1z"/>
        <path
            d="M6 5a.997.997 0 0 0-.293-.707L1.717.303A1 1 0 1 0 .303 1.717L3.586 5 .303 8.283a1 1 0 1 0 1.414 1.414l3.99-3.99A.997.997 0 0 0 6 5z"/>
    </symbol>
    <symbol id="spectrum-css-icon-Star" viewBox="0 0 18 18">
        <path
    ...
    <symbol id="spectrum-css-icon-StarOutline" viewBox="0 0 18 18">
        <path
            d="M9.031 2.541l1.777 4.753 5.11.241-3.987 3.2 1.336 4.913-4.266-2.782-4.282 2.808 1.352-4.937-3.987-3.2 5.1-.245zM9.042.412a.369.369 0 0 0-.349.239L6.486 6.326l-6.1.293a.375.375 0 0 0-.217.667l4.762 3.821L3.318 17a.376.376 0 0 0 .362.475.371.371 0 0 0 .2-.063l5.121-3.351 5.095 3.324a.371.371 0 0 0 .2.062.376.376 0 0 0 .363-.475l-1.595-5.866 4.767-3.826a.375.375 0 0 0-.217-.667l-6.1-.287L9.393.655a.369.369 0 0 0-.351-.243z"/>
    </symbol>
    <symbol id="spectrum-css-icon-SuccessMedium" viewBox="0 0 18 18">
        <path
    ...
    <symbol id="spectrum-css-icon-SuccessSmall" viewBox="0 0 14 14">
        <path
    ...
    <symbol id="spectrum-css-icon-TripleGripper" viewBox="0 0 10 7">
